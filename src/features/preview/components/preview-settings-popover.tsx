...
export const PreviewSettingsPopover = ({
  ...
  const form = useForm({
    defaultValues: {
      ...
      runCommand: initialValues?.runCommand ?? "",
    },
    validators: {
      onSubmit: formSchema,
    },
    onSubmit: async ({ value }) => {
      await updateSettings({
        ...
        settings: {
          ...
          runCommand: value.runCommand || undefined,
        },
      });
      setOpen(false);
      onSave?.();
            ...
            <form.Field name="runCommand">
              {(field) => (
                <Field>
                  ...
                  />
                  <FieldDescription>
                    Optional override for the selected-file runner. Use{" "}
                    <code>{"{file}"}</code> for the active file path.
                  </FieldDescription>
                </Field>
              )}
            </form.Field>
